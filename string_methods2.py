...
string3 = "python"
substring = "on"
result = string3.endswith(substring)
...
separator = "-"
result = separator.join(iterable1)
...
string16 = "python"
result = string16.startswith(substring)
